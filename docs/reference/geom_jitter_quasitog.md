...
"jitterquasitog")\`. It adds a small amount of variation to the location
of each point using bivariate normal distribution derived from Sobol
sequences. This is useful for handling overplotting in smaller datasets.

## Usage

``` r
geom_jitter_quasitog(
  mapping = NULL,
  data = NULL,
  stat = "identity",
  position = NULL,
